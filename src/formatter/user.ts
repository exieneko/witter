...
export const formatUser = (input: _User): User => {
    return {
        ...
        affiliate_label: input.affiliates_highlighted_label.label ? {
        ...
        follow_requested: input.legacy.follow_request_sent || false,
...
export const formatUserLegacy = (input: _User['legacy']): User => {
    return {
        ...
        follow_requested: input.follow_request_sent || false,
